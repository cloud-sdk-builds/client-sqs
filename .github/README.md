...
[`@aws-sdk/client-sqs`](https://www.npmjs.com/package/@aws-sdk/client-sqs/v/3.1110.0).
...
- @aws-sdk/client-sqs v3.1110.0 - [https://cloud-sdk-builds.github.io/?sdk=client-sqs&version=3.1110.0](https://cloud-sdk-builds.github.io/?sdk=client-sqs&version=3.1110.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sqs@3.1110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l6J4OvvLSjN4KSDdSxxPmf/MsidsK3O7+EpToYJYcGrRsXy+s2IDlS86GgOKgoD+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sqs": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sqs@3.1110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sqs@3.1110.0/index.min.mjs": "sha384-l6J4OvvLSjN4KSDdSxxPmf/MsidsK3O7+EpToYJYcGrRsXy+s2IDlS86GgOKgoD+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sqs/blob/refs/tags/3.1110.0/LICENSE
```
